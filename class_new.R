...
Bucket_position <- function(ContractID, Date, Multiplier,Bucket,Para)
{
...
Bucket_position_moving <- function(ContractID, Date, Multiplier,Bucket,Para,Size)
{
  library("caTools")
  Data <- Bucket_position(ContractID, Date, Multiplier,Bucket,Para)
  Position <- data.frame(c(1:length(Data[,i])))
  for(i in 1:(2 * Bucket))
  {
